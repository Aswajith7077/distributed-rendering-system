...
Start-Process -FilePath ".\.venv\Scripts\python.exe" -ArgumentList "run.py --port 8000" -WorkingDirectory "gateway" -WindowStyle Normal

Write-Host "Starting Slave Worker 1 (Port 8001)..." -ForegroundColor Green
Start-Process -FilePath ".\.venv\Scripts\python.exe" -ArgumentList "run.py --port 8001" -WorkingDirectory "slave" -WindowStyle Normal

Write-Host "Starting Slave Worker 2 (Port 8002)..." -ForegroundColor Green
Start-Process -FilePath ".\.venv\Scripts\python.exe" -ArgumentList "run.py --port 8002" -WorkingDirectory "slave" -WindowStyle Normal
